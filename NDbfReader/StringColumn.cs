...
namespace NDbfReader
{
  ...
  public class StringColumn : Column<string>
  {
    ...
    public StringColumn(string name, byte dbfType, int offset, short size, short dec, Encoding encoding)
    ...
    protected override string ValueFromRowBuffer(byte[] buffer)
    {
      var ret = _encoding.GetString(buffer, 0, buffer.Length);                          
